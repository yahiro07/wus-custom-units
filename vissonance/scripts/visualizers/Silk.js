function Silk() {
    ...
    render: function () {
      ...
      if (group) {
        for (var i = 0; i < visualArray.length; i++) {
          group.children[i].children[0].scale.x =
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);
          group.children[i].children[0].scale.y =
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);

          group2.children[i].children[0].scale.x =
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);
          group2.children[i].children[0].scale.y =
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);

          group3.children[i].children[0].scale.x =
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);
          group3.children[i].children[0].scale.y =
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);

          group4.children[i].children[0].scale.x =
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);
          group4.children[i].children[0].scale.y =
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);
          //
          ...
          group2.children[i].position.y +=
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);

          group3.children[i].position.y -=
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);

          group4.children[i].position.y -=
            visualArray[i] <= 1
              ? 0.0001
              : 4 * Math.log10(1 + visualArray[i] / 255 / 7);
  ...
  function setUniformColor(groupI, loudness) {
    ...
    group.children[groupI].children[0].material.uniforms.col.value =
      new THREE.Color(
        "hsl(" +
          h +
          ", 90%, " +
          (100 - Math.min(40, parseInt(loudness))) +
          "%)",
      );
  }
