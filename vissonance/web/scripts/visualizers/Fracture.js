      ...
      if (group) {
        ...
        for (var c = 0; c < group.children.length; c++) {
          ...
          for (var i = 0; i < visualArray.length; i++) {
            ...
            if (c % 2 != 0) {
              group.children[c].geometry.attributes.position.array[i * 3 + 2] =
                visualArray[i] / 10;
              ...
              group.children[c].geometry.attributes.position.array[
                v / 2 - 3 - (numBars * 3 + i * 3) + 2 + numBars * 3
              ] = visualArray[i] / 10;
